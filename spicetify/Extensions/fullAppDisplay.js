...
#fad-art {
                ...
                react.createElement(
                  ...
                  react.createElement(
                    ...
                    react.createElement(DisplayIcon, {
                      icon: Spicetify.SVGIcons[
                        this.state.heart ? "heart-active" : "heart"
                      ],
                      size: 50,
                    })
                  )
  ...
  function updateStyle() {
    style.innerHTML =
      ...
      (checkLyricsPlus() && CONFIG.lyricsPlus
        ? lyricsPlusBase + lyricsPlusStyleChoices[CONFIG.vertical ? 1 : 0]
        : "");
  }
...
`,
    ...
    let configContainer = react.createElement(
      ...
      react.createElement(ConfigItem, {
        name: checkLyricsPlus()
          ? "Enable Lyrics Plus integration"
          : "Lyrics Plus not applied",
        field: "lyricsPlus",
        func: () => {
          updateVisual();
          requestLyricsPlus();
