...
local windows = require("wezconf.windows") -- file located at ~/.config/wezterm/windows.lua
local terminal = require("wezconf.terminal")
local keymaps = require("wezconf.keymaps")
